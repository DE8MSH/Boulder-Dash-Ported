...
For this stage, set C64 bits become palette index 1 and clear bits palette
index 0. SNES and HuC6270/PCE output is 4bpp, 32 bytes per 8x8 tile.
"""
...
def emit_ca65(path: Path, label: str, chars: list[tuple[int, list[int]]]) -> None:
    ...
    lines = [
        ...
        f"; {len(chars)} indexed C64 characters, 32 bytes per 4bpp tile.",
        "",
        f"{label}:",
    ]
